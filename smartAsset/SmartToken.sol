...
contract SmartToken {
  ...
  constructor (address _issuer, address _fstkAuthority, string _name, string _symbol, uint256 _totalSupply, string _metadata) public {}
  ...
  function setLiquid (bool liquidity, uint256 approveTime, bytes approveToken) public {}
