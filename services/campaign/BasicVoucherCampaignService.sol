...
contract BasicVoucherCampaignService {

  constructor (address _fstkAuthority, address _gasTankService) public {}

  event CreateBasicVoucherCampaign (address indexed voucher, address campaign);
  ...
  function createBasicVoucherCampaign (uint256 value, address from, address ca, address voucher, (uint256 startTime, uint256 endTime, uint256 cap, (uint256 numerator, uint256 denominator) priceMultiplier, bool isPrivate) info) public {}
